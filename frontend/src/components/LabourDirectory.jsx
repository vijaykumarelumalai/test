    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Manage permanent and temporary workers & view their mobile app credentials</p>
        </div>
            ...
            return (
              ...
              >
                <div>
                  ...
                  <div className="mt-3 p-3 rounded-xl bg-blue-50/60 border border-blue-200/60">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="mt-1.5 flex items-center justify-between text-xs">
                      <div>
                        <span className="text-slate-400 text-[10px] block">Login Phone:</span>
                        <span className="font-bold text-slate-800">{w.phone}</span>
                      </div>
                      <div className="text-right">
                        <span className="text-slate-400 text-[10px] block">Password / PIN:</span>
                        <span className="font-black text-amber-700 bg-amber-100/90 px-2 py-0.5 rounded-md tracking-wider">
                          {pin}
                        </span>
                      </div>
                    </div>
